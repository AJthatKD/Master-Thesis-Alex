   ...
   - pdf        Evaluaters the joint pdf of a sample vector
    ...
    methods
        ...
        function Obj = ERANataf(M,Correlation)
            ...
            if ~isequal(Obj.Rho_X,Obj.Rho_X') % checking symmetry of correlation matrix (is not done by chol)
        ...
        function jointcdf = cdf(Obj,X)
            ...
            % specified
            if n_dim <= 25 || (Obj.Rho_Z == eye(n_dim))
                ...
                s = mvncdf_alt(-inf(1,Size),U,Obj.Rho_Z,1);
                jointcdf = s.prob;
            end
        end
    end
